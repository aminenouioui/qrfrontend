...
const Dashboard: React.FC = () => {
  ...
  const fetchUserData = async (token: string) => {
    try {
      let response = await fetch('http://10.0.2.2:8000/api/student/profile/', {
        method: 'GET',
        headers: {
      ...
      if (response.status === 401) {
        ...
        response = await fetch('http://10.0.2.2:8000/api/student/profile/', {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.categorySection}>
          ...
          <View style={styles.categoriesGrid}>
            <TouchableOpacity onPress={() => router.push('/schedule')} style={styles.categoryCard}>
              <Image
            ...
            <TouchableOpacity onPress={() => router.push('/grades')} style={styles.categoryCard}>
              <Image
            ...
            <TouchableOpacity onPress={() => router.push('/scan-qr')} style={styles.categoryCard}>
              <Image
      ...
      <View style={styles.bottomNavigation}>
        ...
        <TouchableOpacity style={styles.navItem} onPress={() => router.push('/grades')}>
