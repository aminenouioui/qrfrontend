...
function Teacher_management() {
  ...
  const sections = [
    ...
    },
    {
      ...
      description: "Manage teacher profiles and credentials",
    ...
    },
    {
      ...
      description: "Track teacher presence and absences",
        ...
        <header className="bg-gradient-to-br from-slate-800 to-slate-900 shadow-md dark:bg-slate-800 border-b border-slate-700">
          <div className="flex items-center justify-between p-4">
            ...
            <div className="flex-1 px-4">
              ...
              <p className="text-sm text-slate-400">Manage all teacher-related activities and information</p>
            </div>
