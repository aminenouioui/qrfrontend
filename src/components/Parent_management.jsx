...
function GestionFreres() {
  ...
  const sections = [
    ...
    {
      title: "Notes des Siblings",
      description: "Voir les performances académiques des siblings",
      icon: <Award className="h-10 w-10" />,
      color: "from-green-500 to-green-600",
      stats: "4 392 notes",
      action: "Voir les Notes",
      onClick: () => navigate("/admin/freres/notes"),
    },
    {
      title: "Emplois du Temps des Siblings",
      description: "Voir les emplois du temps des siblings",
      icon: <Clock className="h-10 w-10" />,
      color: "from-purple-500 to-purple-600",
      stats: "42 classes",
      action: "Voir les Emplois du Temps",
      onClick: () => navigate("/admin/freres/emploi-du-temps"),
    },
    {
      title: "Comptes des Frères",
      description: "Gérer les profils et identifiants des frères",
      icon: <UserCog className="h-10 w-10" />,
      color: "from-amber-500 to-amber-600",
      stats: "1 248 comptes",
      action: "Gérer les Comptes",
      onClick: () => navigate("/admin/freres/compte"),
    },
    {
      title: "Présence des Siblings",
